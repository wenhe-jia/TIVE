...
def YTVIS2021(path: str = None, name: str = None, year: int = 2017, ann_set: str = 'val') -> Data:
    """
...
def YTVIS2021Result(path: str, name: str = None) -> Data:
    """ Loads predictions from a COCO-style results file. """
    if name is None: name = default_name(path)
...
def YTVIS2021_perimg(path: str = None, name: str = None, year: int = 2017, ann_set: str = 'val') -> Data:
    """
    Loads ground truth from a ytvis-style annotation file.
    """
    if name is None: name = default_name(path)
...
def YTVIS2021Result_perimg(path: str, data_ann: Data, name: str = None) -> Data:
    """ Loads predictions from a COCO-style results file. """
    if name is None: name = default_name(path)
